...
for fname in 4x4_hard_1.csv 4x4_hard_2.csv 4x4_hard_3.csv
do
	# for ((i=1; i<17; i=i*2));
	# 	do 
			...
			# echo "Threads = $i" >> ./output_A.txt
            # echo "Threads = $i" >> ./output_B_last.txt
            echo "File name = $fname" >> ./output_B_last.txt
			
			# ./fname_blurring_parallel $fname >> ./=======.txt
            # ./part2_A 16 $fname >> ./output_A.txt
            ./part2_B 16 $fname >> ./output_B_last.txt
            # ./part2_C 16 $fname >> ./output_C.txt
	# done	
done
